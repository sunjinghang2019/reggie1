...
public class AddressBookController {
     ...
     */
    @PostMapping
    public Result<AddressBook> save(@RequestBody AddressBook addressBook) {//前端发送过来一个json序列化的addressBook数据
        addressBook.setUserId(BaseContext.getCurrentUserId());//项目中用用户的手机号码作为用户的唯一标识
